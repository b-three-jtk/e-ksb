...
Route::prefix('admin')->name('admin.')->middleware(['auth', 'role:' . implode('|', $adminRoles), 'admin_mode', 'revalidate'])->group(function () {
    ...
    Route::post('/pembiayaan/repayment', [PembiayaanController::class, 'storeRepayment'])->middleware('permission:payment_murabahah')->name('pembiayaan.repayment.request');
    ...
    Route::post('/pembiayaan/pembayaran/struk', [PembiayaanController::class, 'showPaymentSuccess'])->middleware('permission:view_murabahah')->name('pembiayaan.pembayaran.success');
