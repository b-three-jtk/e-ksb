...
Route::prefix('admin')->name('admin.')->middleware(['auth', 'role:' . implode('|', $adminRoles), 'admin_mode', 'revalidate'])->group(function () {
    ...
    Route::get('/pembiayaan', [PembiayaanController::class, 'index'])->middleware('permission:view_murabahah')->name('pembiayaan.index');
    Route::get('/pembiayaan/show/{id}', [PembiayaanController::class, 'show'])->middleware('permission:view_murabahah')->name('pembiayaan.show');
    Route::get('/pembiayaan/create', [PembiayaanController::class, 'create'])->middleware('permission:create_murabahah')->name('pembiayaan.create');
    ...
    Route::get('/pemasok/search', [PembiayaanController::class, 'searchPemasoks'])->middleware('permission:create_murabahah')->name('pemasok.search');
    Route::post('/pembiayaan/draft', [PembiayaanController::class, 'saveDraft'])->middleware('permission:create_murabahah')->name('pembiayaan.draft');
    Route::post('/pembiayaan/finalize', [PembiayaanController::class, 'finalize'])->middleware('permission:create_murabahah')->name('pembiayaan.finalize');
    Route::post('/pembiayaan/store', [PembiayaanController::class, 'store'])->middleware('permission:create_murabahah')->name('pembiayaan.store');
    ...
    Route::post('/pembiayaan/rekening-anggota', [PembiayaanController::class, 'storeRekening'])->middleware('permission:edit_murabahah')->name('pembiayaan.rekening.store');
    ...
    Route::get('/pembiayaan/repayment/{id}', [PembiayaanController::class, 'showRepayment'])->middleware('permission:edit_murabahah')->name('pembiayaan.repayment');
    Route::post('/pembiayaan/repayment', [PembiayaanController::class, 'storeRepayment'])->middleware('permission:edit_murabahah')->name('pembiayaan.repayment.request');
    Route::get('repayment/{id}/receipt', [PembiayaanController::class, 'viewRepaymentReceipt'])->middleware('permission:edit_murabahah')->name('pembiayaan.repayment.view');
    Route::get('repayment/{id}/download', [PembiayaanController::class, 'downloadRepaymentReceipt'])->middleware('permission:edit_murabahah')->name('pembiayaan.repayment.download');
    Route::get('/pembiayaan/{pembiayaan}/payments/create',[PembiayaanController::class, 'createPayment'])->middleware('permission:edit_murabahah')->name('pembiayaan.payments.create');
    ...
    Route::get('/kas/export/excel',[AruskasController::class, 'exportExcel'])->middleware('permission:view_kas')->name('kas.export.excel');
    Route::get('/kas/export/cashflow',[AruskasController::class,'exportCashflow'])->middleware('permission:view_kas')->name('kas.export.cashflow');
...
Route::prefix('user')->name('user.')->middleware(['auth', 'member_access', 'revalidate'])->group(function () {
    ...
    // Pembiayaan
    Route::get('/pembiayaan', [UserPembiayaanController::class, 'index'])->name('pembiayaan.index');
    Route::get('/pembiayaan/show/{id}', [UserPembiayaanController::class, 'show'])->name('pembiayaan.show');
});
