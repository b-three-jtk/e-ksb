...
const user = computed(
    () =>
        page.props.auth?.user || {
            ...
            foto_profil: "/public/images/user/owner.jpg",
        },
);
...
const menuItems = [{ href: "/admin/profile", icon: UserIcon, text: "Profil" }];
...
<template>
    <div class="relative" ref="dropdownRef">
        ...
        >
            ...
            <ul
                class="flex flex-col gap-1 pt-4 pb-3 border-b border-gray-200 dark:border-gray-500"
            >
