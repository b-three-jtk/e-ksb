            ...
            <table class="min-w-full">
                <thead>
                    <tr class="border-t border-gray-100 dark:border-gray-800">
                        <th v-for="column in columns" :key="column.key" class="py-5 text-left">
                            <p class="font-medium text-gray-500 text-theme-xs dark:text-gray-400">{{ column.label }}</p>
                        </th>
                    </tr>
                </thead>
                <tbody>
                    <tr v-for="(row, index) in data" :key="index" class="border-t border-gray-100 dark:border-gray-800">
                        <td v-for="column in columns" :key="column.key" class="py-5 whitespace-nowrap">
