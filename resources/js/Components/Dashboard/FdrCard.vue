    ...
    <div
        ...
        <div class="flex justify-between items-center mb-6">
            <div class="flex items-center gap-3">
                <div class="w-10 h-10 rounded-full bg-[#e8f5e9] flex items-center justify-center text-brand-800 text-2xl dark:bg-green-900/30">
        ...
        <div class="relative pt-4 pb-2">
            ...
            <div
                ...
                <!-- Zone Kurang (< 85) -->
                <!-- 85 / 140 = 60.714% -->
                <div class="h-full bg-amber-50 dark:bg-amber-900/30 border-r border-amber-200 dark:border-amber-500/50"
                    style="width: 60.714%;"></div>

                <!-- Zone Aman (85 - 100) -->
                <!-- 15 / 140 = 10.714% -->
                <div class="h-full bg-[#e8f5e9] dark:bg-green-900/40 border-r border-[#81c784] dark:border-green-500/50"
                    style="width: 10.714%;"></div>

                <!-- Zone Berisiko (> 100) -->
                <!-- 40 / 140 = 28.572% -->
                <div class="h-full bg-red-50 dark:bg-red-900/30" style="width: 28.572%;"></div>
            </div>

            <div class="absolute top-[22px] h-6 w-0.5 bg-gray-900 dark:bg-white -translate-x-1/2 rounded-full"
