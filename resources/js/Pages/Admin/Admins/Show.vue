        ...
        <div class="flex flex-col">
            ...
            <div class="flex flex-col gap-6">
                <div class="card-layout flex justify-between items-center">
                    <div class="flex gap-6">
                        <div v-if="user.foto_profil">
                            <img class="w-20 h-20 rounded-full object-cover bg-gray-400" :src="user.foto_profil"
                                alt="User avatar" />
                        </div>
                        <div v-else
                ...
                <div class="card-layout grid gap-5">
                    <div class="grid grid-cols-1 gap-8 py-3">
                        ...
                        <ul class="grid xl:grid-cols-2 grid-cols-1 gap-6">
                            ...
                            <li class="flex flex-col gap-2">
                                ...
                                <span class="font-medium text-dark-text dark:text-white">{{ user.no_telp ?? "-"
                                }}</span>
                            </li>
                            <li class="flex flex-col gap-2">
