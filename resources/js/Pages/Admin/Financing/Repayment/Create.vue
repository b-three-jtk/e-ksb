            ...
            <div class="card-layout px-0!">
                ...
                <div class="card-layout mx-8 mt-8">
                    <ul class="grid grid-cols-1 md:grid-cols-2 gap-6 mt-4">
                        <li>
                            <Info label="Nomor Anggota KSPPS" :value="props.data?.financing?.anggota.user.kode_pengguna" />
                        </li>
                        <li>
                            <Info label="Nama Lengkap" :value="props.data?.financing?.anggota.user.nama" />
                        </li>
                        <li>
