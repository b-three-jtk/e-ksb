                    ...
                    <div class="card-layout col-span-3">
                        ...
                        <ul class="grid grid-cols-2 gap-6 mb-4">
                            <li class="flex flex-col gap-2">
                                ...
                                <span class="font-medium text-dark-text dark:text-white">Rp {{ transaction.amount
                                    }}</span>
                            </li>
                            <li class="flex flex-col gap-2">
                                <span class="text-sm text-gray-500 dark:text-gray-300">Kategori Simpanan</span>
                                <span class="font-medium text-dark-text dark:text-white">{{ transaction.category
                                    }}</span>
                            </li>
                            <li class="flex flex-col gap-2">
                                <span class="text-sm text-gray-500 dark:text-gray-300">Akad</span>
                                <span class="font-medium text-dark-text dark:text-white">
                                    {{ transaction.category === 'Simpanan Sukarela' ? 'Wadiah Yad Dhamanah' :
                                    'Musyarakah'
                                    }}
                                </span>
                            </li>
                            ...
                            <li class="flex flex-col gap-2">
                                ...
                                <span class="font-medium text-dark-text dark:text-white">{{ transaction.description
                                    }}</span>
                            </li>
                        </ul>
                    </div>
                        ...
                        <div class="card-layout h-full flex flex-col gap-6">
                            ...
                            <ul class="grid grid-cols-1 gap-6">
                                ...
                                <li class="flex justify-between">
                                    ...
                                    <span class="font-medium text-dark-text dark:text-white">{{ member.work_unit
                                        }}</span>
                                </li>
                            </ul>
                        </div>
