...
const contactFields = computed(() => [
    { label: "Nomor Telepon", value: displayValue(user.value.no_telp) },
                        ...
                        <div class="grid grid-cols-1 gap-8 py-6">
                            ...
                            <ul class="grid xl:grid-cols-2 grid-cols-1 gap-6">
                                ...
                                >
                                    ...
                                    >
                                    <span
                                        class="font-medium text-dark-text dark:text-white whitespace-pre-line"
                                        >{{ field.value }}</span
                                    >
                                </li>
                            </ul>
                                ...
                                >
                                    ...
                                    <div class="grid grid-cols-2 gap-4 text-sm">
                                        <div>
                                            ...
                                            <p
                                                class="mt-1 font-medium text-dark-text dark:text-white"
                                            >
                                                {{
                                        ...
                                        <div>
                                            ...
                                            >
                                                +{{
                                                    formatPoint(
                                                        pointSummary.latest_points_earned,
                                                    )
                                                }}
                                                Poin
                                            </p>
                                        ...
                                        <div>
                                            ...
                                            >
                                                {{
                                                    formatCurrency(
                                                        pointSummary.latest_total_simpanan,
                                                    )
                                                }}
                                            </p>
                                        </div>
                                    ...
                                    >
                                        ...
                                        <tbody class="divide-y divide-stroke dark:divide-gray-700">
                                            ...
                                            >
                                                ...
                                                <td
                                                    class="px-5 py-4 text-dark-text dark:text-white"
                                                >
                                                    {{
                                                        formatCurrency(
                                                            row.total_simpanan,
