...
const updatePhoneNumber = (value) => {
    form.no_telp = String(value ?? "").replace(/\D/g, "");
};
...
const handleDeletePicture = () => {
    if (!selectedFile.value && !props.user.foto_profil) {
            ...
            form.put("/user/profile", {
                ...
                onSuccess: () => {
                    ...
                    if (selectedFile.value) {
                        ...
                        formData.append("foto_profil", selectedFile.value);
                        ...
                        router.post("/user/profile/picture", formData, {
                            ...
                            onError: () => {
                                uploading.value = false;
                                toast.error(
                                    "Data profil berhasil disimpan, tetapi foto profil gagal diunggah. Silakan coba unggah foto kembali.",
                                    {
                                        autoClose: 3000,
                                        position: "bottom-right",
                                    },
                        ...
                        router.delete("/user/profile/picture", {
                            ...
                            onError: () => {
                                deleting.value = false;
                                toast.error(
                                    "Data profil berhasil disimpan, tetapi foto profil gagal dihapus. Silakan coba hapus foto kembali.",
                                    {
                                        autoClose: 3000,
                                        position: "bottom-right",
                                    },
            ...
            <div class="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
                ...
                <form @submit.prevent="submit" class="space-y-6">
                    ...
                    <div class="card-layout grid gap-5">
                        <div
                            class="card-layout py-0! grid xl:grid-cols-2 grid-cols-1 xl:gap-x-10"
                        >
                            <div class="grid grid-cols-1 gap-8 py-6 xl:pr-8">
                                <h1 class="card-title">Identitas Pribadi</h1>
                                <div
                                    class="grid xl:grid-cols-2 grid-cols-1 gap-4"
                                >
                                    <div
                            ...
                            >
                                ...
                                <div
                                    class="grid xl:grid-cols-2 grid-cols-1 gap-6"
                                >
                                    <div
