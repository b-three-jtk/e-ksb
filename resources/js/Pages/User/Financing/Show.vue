...
const breadcrumbItems = [
    ...
    { name: 'Pengelolaan Pembiayaan', link: '/user/financings' },
...
<template>
    <BaseLayout title="Detail Pembiayaan">
        <div class="mt-30 mb-10 container mx-auto">
            ...
            <div class="card-layout px-0!">
                ...
                <div class="flex flex-col px-12 pb-2 pt-4 gap-2">
                    ...
                    <div class="card-layout grid grid-cols-2 gap-6">
                        ...
                        <Info label="Tanggal Akad" :value="formatDate(data.akad_date)" />
                ...
                <div class="flex flex-col px-12 py-2 gap-2">
                    <div class="flex justify-between items-center">
                        ...
                        <div class="flex items-center gap-4">
                            <Button
                                v-if="can['edit_murabahah'] && data.installment && data.status == 'Angsuran Berjalan'"
                                :href="`/admin/financings/repayment/${data.id}`" variant="secondary" size="small">
                                <span class="icon-[tabler--moneybag-move]" style="width: 18px; height: 18px;"></span>
                                Pelunasan Dipercepat
                            </Button>
                            <Button
                                v-if="can['edit_murabahah'] && data.installment && data.status == 'Angsuran Berjalan'"
                                :href="`/admin/financings/${data.id}/payments/create`" variant="info" size="small">
                    ...
                    <div class="card-layout px-0!">
                        ...
                        <div class="py-8 px-8"
                            ...
                            <FinancingChart :data="data.installment?.payment" :total-price="Number(data.total_price)"
                ...
                <div class="flex flex-col px-12 py-2 gap-2">
                    ...
                    <div class="card-layout p-0!">
                        <table class="min-w-full text-center">
                            ...
                            <tbody v-if="data.installment && data.installment?.length > 0">
                                <tr v-for="i in data.installment"
                                    ...
                                    <td class="py-5 px-2 whitespace-nowrap">
                                        <span class="font-semibold rounded-lg px-3 py-1 text-xs"
                                            :class="i.payment?.is_early_repayment ? 'text-blue-600 bg-blue-50' : 'text-green-600 bg-green-50'">
